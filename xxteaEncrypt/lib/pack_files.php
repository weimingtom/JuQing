...
//require_once('C:/Users/Administrator/Desktop/pack_files/lib/quick/FilesPacker.php');
define('XXTEA_PATH', dirname(__FILE__).DIRECTORY_SEPARATOR);
include XXTEA_PATH.'/quick/FilesPacker.php';
